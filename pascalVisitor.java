...
public interface pascalVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link pascalParser#classDefinitionPart}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitClassDefinitionPart(pascalParser.ClassDefinitionPartContext ctx);
	/**
	 * Visit a parse tree produced by {@link pascalParser#privateOrPublic}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitPrivateOrPublic(pascalParser.PrivateOrPublicContext ctx);
	/**
	 * Visit a parse tree produced by {@link pascalParser#classVariableDefinition}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitClassVariableDefinition(pascalParser.ClassVariableDefinitionContext ctx);
	/**
	 * Visit a parse tree produced by {@link pascalParser#classProcedureAndFunctionDeclarationPart}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitClassProcedureAndFunctionDeclarationPart(pascalParser.ClassProcedureAndFunctionDeclarationPartContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link pascalParser#classFuncStatement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitClassFuncStatement(pascalParser.ClassFuncStatementContext ctx);
	/**
