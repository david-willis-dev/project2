...
public interface delphiVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link delphiParser#classDefinitionPart}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitClassDefinitionPart(delphiParser.ClassDefinitionPartContext ctx);
	/**
	 * Visit a parse tree produced by {@link delphiParser#privateOrPublic}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitPrivateOrPublic(delphiParser.PrivateOrPublicContext ctx);
	/**
	 * Visit a parse tree produced by {@link delphiParser#classVariableDefinition}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitClassVariableDefinition(delphiParser.ClassVariableDefinitionContext ctx);
	/**
	 * Visit a parse tree produced by {@link delphiParser#classProcedureAndFunctionDeclarationPart}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	...
	/**
	 * Visit a parse tree produced by {@link delphiParser#classFuncStatement}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitClassFuncStatement(delphiParser.ClassFuncStatementContext ctx);
	/**
