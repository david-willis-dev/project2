...
public interface pascalListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link pascalParser#classDefinitionPart}.
	 * @param ctx the parse tree
	 */
	void enterClassDefinitionPart(pascalParser.ClassDefinitionPartContext ctx);
	/**
	 * Exit a parse tree produced by {@link pascalParser#classDefinitionPart}.
	 * @param ctx the parse tree
	 */
	void exitClassDefinitionPart(pascalParser.ClassDefinitionPartContext ctx);
	/**
	 * Enter a parse tree produced by {@link pascalParser#privateOrPublic}.
	 * @param ctx the parse tree
	 */
	void enterPrivateOrPublic(pascalParser.PrivateOrPublicContext ctx);
	/**
	 * Exit a parse tree produced by {@link pascalParser#privateOrPublic}.
	 * @param ctx the parse tree
	 */
	void exitPrivateOrPublic(pascalParser.PrivateOrPublicContext ctx);
	/**
	 * Enter a parse tree produced by {@link pascalParser#classVariableDefinition}.
	 * @param ctx the parse tree
	 */
	void enterClassVariableDefinition(pascalParser.ClassVariableDefinitionContext ctx);
	/**
	 * Exit a parse tree produced by {@link pascalParser#classVariableDefinition}.
	 * @param ctx the parse tree
	 */
	void exitClassVariableDefinition(pascalParser.ClassVariableDefinitionContext ctx);
	/**
	 * Enter a parse tree produced by {@link pascalParser#classProcedureAndFunctionDeclarationPart}.
	 * @param ctx the parse tree
	 */
	void enterClassProcedureAndFunctionDeclarationPart(pascalParser.ClassProcedureAndFunctionDeclarationPartContext ctx);
	/**
	 * Exit a parse tree produced by {@link pascalParser#classProcedureAndFunctionDeclarationPart}.
	 * @param ctx the parse tree
	 */
	void exitClassProcedureAndFunctionDeclarationPart(pascalParser.ClassProcedureAndFunctionDeclarationPartContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link pascalParser#classFuncStatement}.
	 * @param ctx the parse tree
	 */
	void enterClassFuncStatement(pascalParser.ClassFuncStatementContext ctx);
	/**
	 * Exit a parse tree produced by {@link pascalParser#classFuncStatement}.
	 * @param ctx the parse tree
	 */
	void exitClassFuncStatement(pascalParser.ClassFuncStatementContext ctx);
	/**
